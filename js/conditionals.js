...
function analyzeColor(color) {
    if (color === "blue") {
        ...
        return "Red is the color of a unit test before it passes.";
    } else if (color === "yellow") {
        return "Yellow means slow down!";
    } else {
        return "I don't know anything about the color " + color + ".";
    }
}
// var message = analyzeColor("off-white");
// console.log(message);
 ...
 */
// var usersColor = prompt("Please name a color.");
...
// var result = calculateTotal(3, 10);
// console.log(result);
